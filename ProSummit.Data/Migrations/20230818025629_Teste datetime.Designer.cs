...
namespace ProSummit.Data.Migrations
{
    ...
    [Migration("20230818025629_Teste datetime")]
    partial class Testedatetime
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProSummit.Core.Entities.Batch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ProSummit.Core.Entities.Speaker", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("SpeakerSummitEvent", b =>
                {
            ...
            modelBuilder.Entity("SpeakerSummitEvent", b =>
                {
                    b.HasOne("ProSummit.Core.Entities.SummitEvent", null)
                        .WithMany()
                        .HasForeignKey("EventsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProSummit.Core.Entities.Speaker", null)
                        .WithMany()
